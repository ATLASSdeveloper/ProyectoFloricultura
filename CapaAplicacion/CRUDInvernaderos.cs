...
{
    public partial class CRUDInvernaderos : Form
    {
        ...
        private void crear_Click(object sender, EventArgs e)
        {
            ...
            if (!this.flores.Text.ToString().Equals(""))
            {
                valor = this.flores.SelectedValue.ToString();
            }
            string mensaje = agregar.agregarInvernadero(nombre, capacidad, valor);
            if (mensaje.Equals(""))
            {
                cargaDatosTabla();
                limpiarFormulario();
        ...
        private void editar_Click(object sender, EventArgs e)
        {
            ...
            string nombre = this.inputNombre.Text.ToString();
            string capacidad = this.inputCapacidad.Text.ToString();
